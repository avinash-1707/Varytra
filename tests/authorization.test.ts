...
describe('authorization', () => {
  it('enforces every role capability and denial path', () => {
    const allowed = {
      owner: ['members:read', 'members:write', 'projects:read', 'projects:create', 'projects:update', 'projects:delete', 'versions:read', 'versions:create', 'api_keys:create', 'api_keys:manage_any', 'api_keys:manage_own', 'audit:read'],
      admin: ['members:read', 'members:write', 'projects:read', 'projects:create', 'projects:update', 'projects:delete', 'versions:read', 'versions:create', 'api_keys:create', 'api_keys:manage_any', 'api_keys:manage_own', 'audit:read'],
